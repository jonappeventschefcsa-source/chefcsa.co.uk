    ...
    <footer className="bg-forest text-cream/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-10 pt-8 border-t border-cream/10 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-cream/40">
          <p>&copy; {new Date().getFullYear()} Chefcsa. All rights reserved.</p>
          <div className="flex gap-4 items-center">
            <Link href="/terms" className="hover:text-cream/60 transition-colors">
              Terms
            </Link>
            <span className="text-cream/20">|</span>
            <Link href="/dashboard/login" className="hover:text-cream/60 transition-colors">
              Admin
            </Link>
            <span className="text-cream/20">|</span>
            <Link href="/accessibility" className="hover:text-cream/60 transition-colors">
              Accessibility
            </Link>
          </div>
        </div>
